...
namespace CategorizedBillMenus {
    ...
    public class CategorizerThingCategory : CategorizerSingleton {
        ...
        public static readonly CategorizerThingCategory Instance = new CategorizerThingCategory();
        ...
        public bool IsDisabled(ThingCategoryDef def) => disabledCatDefs.Contains(def);
        ...
        public override void DoSettings(Rect rect, float widthScroll, ref float curY) {
